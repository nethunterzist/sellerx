...
| Alan | Sayı / Kaynak |
|------|----------------|
| Paket sayısı | 30 (activitylog, admin, ai, alerts, auth, billing, buybox, categories, common, config, controller, currency, dashboard, education, email, expenses, financial, notifications, orders, products, purchasing, qa, referral, returns, stocktracking, stores, support, trendyol, users, webhook) |
...
| @Scheduled metodları | 18 (HybridSyncScheduleConfig 8, TrendyolOrderScheduledService 2, TrendyolFinancialSettlementScheduledService 2, StockTrackingScheduledService 2, BuyboxScheduledService 1, CurrencyService 1, PatternDiscoveryService 1, SeniorityService 1) |

### Frontend (sellerx-frontend)

| Alan | Sayı / Kaynak |
|------|----------------|
| Sayfa (page.tsx) | 54 — sprint-4/01-page-list.md ile aynı |
...
| architecture/ | 19 dosya (README + 18 mimari doc) |
...
| Backend domain'ler | sprint-3/01-domain-list.md | 30 paket listelenmiş; StockDepletionService, PurchaseOrderExcelService dahil. |
| Scheduled job'lar | sprint-3/02-scheduled-jobs.md | 18 metod, cron/fixedRate ve ShedLock doc'ta. |
| Frontend sayfalar | sprint-4/01-page-list.md | 54 sayfa path ve layout ile eşleşiyor. |
